define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    API.addStimulusSets({
        ...
        Q1          : [{inherit:'defaultStim', media: 'حددي ما  نوع الشعور الذي اتاكي من  الجمله عندما تخيلتي الوضع الموصوف.اذا كان إيجابي اضغط   1 واذا كان حيادي اضغط 2 واذا سلبي اضغط  3'}],
    ...
    API.addTrialSet('scripts', [
        ...
        {inherit: 'stimulus_trial', data: {text: 'انا افوز بالمرتبه الأولى واحصل على منحه تعليميه كامله  ', sid: 4}},
        {inherit: 'stimulus_trial', data: {text: 'انا واصدقائي نرقص كل الليل في حفل تخرجنا الجامعي  ', sid: 5}},
        {inherit: 'stimulus_trial', data: {text: 'لقد اخترت ضمن البعثه الطلابيه الى كندا هذا الصيف  ', sid: 6}},
        {inherit: 'stimulus_trial', data: {text: 'أقوم بإصدار البومي الموسيقي الأول ويقوم بحصد ملايين المبيعات  ', sid: 7}},
        {inherit: 'stimulus_trial', data: {text: 'انا اتلقى مكالمه هاتفيه حول إيجاد كمبيوتري الضائع   ', sid: 8}}
    ]);
