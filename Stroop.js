 	...
 	API.addCurrent({
        ...
        instructions: {
            inst_welcome : `<p>مرحبا وشكرا على مشاركتكم في بحثنا</p></br>
                            ...
                            <p> يعد القراءه الرجاء التخيل انفسكم بالوضع الموصوف في كل جمله وبعد ذلك الضغط على الفراغ </p></br>
                            <p> الجمله تختفي من الشاشه وبعد ذلك يؤلب منكم الجواب على 9 اسئله </p></br>                          
                            <p>الاجوبه المناسبه تضفط بواسطة الضغط على لوجة المفاتيح </p></br>
