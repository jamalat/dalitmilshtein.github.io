define(['pipAPI'], function(APIconstructor) {
  ...
  API.addSettings('logger', {
    ...
    API.addStimulusSets({
        ...
        Q1          : [{inherit:'defaultStim', media: 'حددي ما  نوع الشعور الذي اتاك من  الجمله عندما تخيلتي الوضع الموصوف.اذا كان إيجابي اضغط   1 واذا كان حيادي اضغط 2 واذا سلبي اضغط  3'}],
        ...
        Q6          : [{inherit:'defaultStim', media: 'حددي من 1 حتى 9 كم استهلكتي من الجهد حتى تتوقفي عن التفكير بالوضع الموصوف بالجمله  ؟1 بلاا جهد9 جهد كبير  '}],    
	    ...
	    Q9          : [{inherit:'defaultStim', media: ' حددي من 1 حتى 9 كم كان الوضع الموصوف في الجمله مرتبط يمخاوفكي؟1 غير مرتبط بتاتا9مرتبط جدا  '}]   
     ...
     ***********************************************/
		...
		{inherit: 'stimulus_trial', data: {text: 'بينما احفر في ساحة البيت أقوم بإيجاد مالا مدفونا  ', sid:31}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا اجري فحوصات طبيه والطبيب يخبرني اني صحيه للغايه ', sid: 44}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا واصدقائي مسافرون جمبعا  في السياره متجهون الى البحر   ', sid: 57}},
	        {inherit: 'stimulus_trial', data: {text: 'انا اجلس امام البحيره على كرسي خشبي وبيدي قهوتي   ', sid: 58}},
	        {inherit: 'stimulus_trial', data: {text: 'تصلون لاخباري عن توقيف تعليمي الجامعي بسبب علاماتي الممنخفضه    ', sid: 71}},
	        {inherit: 'stimulus_trial', data: {text: 'محاضري الجامعي يحاول ان يغتصبني بعد ان قمت برفضه ', sid: 72}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' أرى علامه موجبه على فاحص الحمل بينما انا عزباء  ', sid: 93}},
	        {inherit: 'stimulus_trial', data: {text: ' في حين تجولي خارجا اسمع صوت صافرات وذوي انفجار   ', sid: 94}},
		{inherit: 'stimulus_trial', data: {text: 'سبب جرح لم اعاينه في يدي سيقومون بقطعها كليا  ', sid: 95}},
		...
		{inherit: 'stimulus_trial', data: {text: 'أقوم بشغيل الجهاز بعد ان قرات التعليمات حول استخدامه ', sid: 147}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا انظر بالمراه وارى ان وجهي يتفتفت لفتت صغيره    ', sid: 214}},
		{inherit: 'stimulus_trial', data: {text: 'انا امراه عجوز جدا مع شعر ابيض وجلد مترهل     ', sid: 215}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: 'انا اصل الى بيت والداي  واجد مكان البيت انقاذا    ', sid: 218}},
		...
		{inherit: 'stimulus_trial', data: {text: 'يغمى علي وعند استيقاظي اكتشف انني استطيع قراءة  الأفكار   ', sid: 253}},
	        ...
	        {inherit: 'stimulus_trial', data: {text: ' انا افوز بمنافسة ملكة جمال العالم لعام الفبن وعشرين      ', sid: 282}}
	    ]);
